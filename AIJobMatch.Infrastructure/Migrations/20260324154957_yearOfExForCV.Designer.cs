...
namespace AIJobMatch.Infrastructure.Migrations
{
    ...
    [Migration("20260324154957_yearOfExForCV")]
    partial class yearOfExForCV
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIJobMatch.Domain.Entities.JobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProfilesSnapshot")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AIJobMatch.Domain.Entities.MockInterview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CustomTargetJobTitle")
                        .HasColumnType("text");
                    ...
                    b.ToTable("MockInterview");
                });

            modelBuilder.Entity("AIJobMatch.Domain.Entities.MockInterviewDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AIJobMatch.Domain.Entities.JobApplication", b =>
                {
                    ...
                    b.HasOne("AIJobMatch.Domain.Entities.CandidateProfile", "CandidateProfile")
                        .WithMany("JobApplications")
                        .HasForeignKey("CandidateProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AIJobMatch.Domain.Entities.JobPosting", "JobPosting")
                        .WithMany("JobApplications")
            ...
            modelBuilder.Entity("AIJobMatch.Domain.Entities.MockInterviewDetail", b =>
                {
                    b.HasOne("AIJobMatch.Domain.Entities.MockInterview", "MockInterview")
                        .WithMany("Details")
